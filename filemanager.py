...
while True:
    ...
    if key_input_.isdigit() and int(key_input_) in main_menu:
        ...
        if key_input == 1:
            ...
            result = copy_file_dir(input('Введите имя объекта для копирования: '), input('Введите новое имя объекта: '))
            print(result)
        elif key_input == 4:
            result = list_curr_dir()
            print(result)
        elif key_input == 5:
            result = list_curr_dir_dirs()
            print(result)
        elif key_input == 6:
            result = list_curr_dir_files()
            print(result)
        elif key_input == 7:
